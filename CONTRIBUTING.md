...
2. The ``docs/`` folder must match the documentation generated by re-generating the documentation (see [Re-Generating Documentation](#re-generating-documentation))
